...
document_repo_path = '/Users/leela.krishna/Downloads/app/app/document_repo/'
...
load_llm_locally = False


if load_llm_locally == True:
...
def main():
    ...
    st.sidebar.image(icons_dir+"centific.png", use_column_width=True)
    ...
    st.sidebar.image(
    [
        icons_dir + "centific.png",
        icons_dir + "Lenovo.png",
        icons_dir + "Nvidia-H.png",
        icons_dir + "Pitaya1.png"
        ],
        width=100
    )
